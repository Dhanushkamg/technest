...
export const GuestOrderSuccessPage: React.FC = () => {
  ...
  const { data: order, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      const res = await axios.get(`/api/v1/orders/guest/${orderId}?token=${token}`);
      return res.data;
    },
    ...
    return (
      <div className="max-w-md mx-auto px-4 py-20">
        <ErrorState
          ...
          description={`Could not retrieve guest order details for #${orderId}.`}
          action={
            <Link to="/">
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      >
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm max-w-md mx-auto mb-6">
          Thank you for your guest order! We have sent a confirmation email to {order.guestEmail}.
        </p>
